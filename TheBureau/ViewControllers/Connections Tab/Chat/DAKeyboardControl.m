...
- (void)inputKeyboardWillShow:(NSNotification *)notification
{
    ...
    keyboardEndFrameWindow = CGRectMake(keyboardEndFrameWindow.origin.x, keyboardEndFrameWindow.origin.y + 20, keyboardEndFrameWindow.size.width, keyboardEndFrameWindow.size.height);
