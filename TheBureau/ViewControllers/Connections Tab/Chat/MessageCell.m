...
-(void)setImageView
{
    ...
    _textView.text = @"Hi How are you? Hi How are you?";
    [_textView sizeToFit];
    
    
    //CGFloat max_witdh = 0.7*self.contentView.frame.size.width;
    _chatImage.frame = CGRectMake(0, 0, max_witdh, MAXFLOAT);
    ...
    //_chatImage.image = _message.image;
    
    CGFloat textView_x;
    CGFloat textView_y;
    CGFloat textView_w = 200;
    CGFloat textView_h = 150;
    ...
    _chatImage.autoresizingMask = autoresizing;
    _chatImage.frame = CGRectMake(textView_x + 2, textView_y - 2 + 10, textView_w, textView_h - 20);
